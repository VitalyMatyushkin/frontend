...
class EditTeamTools{
    ...
    async checkEditPage(){
        ...
        await this.driver.wait(until.elementLocated(this.listPlayerLocator),20000);
        await this.driver.wait(until.elementIsVisible(await this.driver.findElement(this.listPlayerLocator)),20000);
    ...
    async editAges(ages){
        ...
        const deselect = (await agesField.findElements(this.buttonLocator))[1];
    ...
    async addPlayers(players){
        await this.driver.wait(until.elementLocated(By.className('ePlayerChooser_playerList')),20000);
    ...
    async deletePlayers(players){
        await this.driver.wait(until.elementLocated(this.managerPlayerLocator),20000);
        await this.driver.sleep(1000);
