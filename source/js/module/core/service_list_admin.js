...
const serviceList = {
	...
	initialize: function(binding) {
		...
		serviceList.schoolAllowedSports = new Service('/superadmin/schools/{schoolId}/allowedSports', binding);
		...
		serviceList.allNotifications = new Service('/superadmin/notifications', binding);
