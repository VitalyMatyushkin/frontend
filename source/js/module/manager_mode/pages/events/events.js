		...
		return <div>
            ...
            <div className='bEvents'>
                <RouterView routes={ binding.sub('eventsRouting') } binding={rootBinging}>
                    <Route path='/events/calendar'  binding={binding}component='module/manager_mode/pages/events/events_calendar'   />
                    <Route
                        path='/events/manager'
                        binding={{default: binding.sub('newEvent'), sports: binding.sub('sports'), calendar: binding.sub('calendar')}}
                        component='module/manager_mode/pages/events/event_manager'  />
                    <Route path='/events/challenges' binding={binding} component='module/manager_mode/pages/events/events_challenges'  />
                    <Route path='/events/invites' binding={binding} component='module/manager_mode/pages/events/events_invites'  />
                </RouterView>
            </div>
        </div>;
	}
