...
PermissionsListPage = React.createClass({
    ...
    _getRemoveFunction: function(data) {
        ...
        window.Server.schoolModelPermission.delete(data.schoolId, data.id).then(function (data) {
    ...
    getTableView: function() {
        ...
        return (
            <Table title="Permissions" binding={binding} onItemRemove={self._getRemoveFunction} onFilterChange={self.updateData}>
