	...
	render: function() {
		...
		return (
			<RouterView routes={ binding } binding={globalBinding}>
				<Route path="/schools/add" binding={binding} component="module/as_manager/pages/schools/schools_add"  />
				<Route path="/schools" binding={binding} component="module/as_manager/pages/schools/schools_list" />
			</RouterView>
		)
	}
});
