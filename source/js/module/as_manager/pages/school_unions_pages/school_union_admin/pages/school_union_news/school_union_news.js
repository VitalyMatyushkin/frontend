	...
	render: function() {
		...
		return (
			<RouterView routes={ binding.sub('newsRouting') } binding={globalBinding}>
				<Route path="/school_union_admin/news" binding={binding.sub('newsList')} formBinding={binding.sub('classesForm')} component={NewsListComponent} />
				<Route path="/school_union_admin/news/add"  binding={binding.sub('newsAdd')} component={NewsAddComponent} />
				<Route path="/school_union_admin/news/edit" binding={binding.sub('newsForm')} component={NewsEditComponent}  />
				<Route path="/school_union_admin/news/view" binding={binding.sub('newsView')} component={NewsViewComponent}  />
			</RouterView>
		)
	}
});
