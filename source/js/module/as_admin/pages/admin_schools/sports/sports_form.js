...
const SportsForm = React.createClass({
	...
	render: function() {
		const 	self    					= this,
				...
				individualResultsAvailable 	= binding.meta().get('individualResultsAvailable.value'),
				optionsPoint				= individualResultsAvailable ? SportsHelpers.clientPointDisplayArray
