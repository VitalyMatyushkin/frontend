...
const 	ImportStudentsComponent 	= require('module/as_admin/pages/admin_schools/import_students_module'),
		...
		ActivateStudentsComponent 	= require('module/as_admin/pages/admin_schools/activate_students');
	...
	createSubMenu: function(){
		...
		const _createSubMenuData = function(){
			let menuItems = [
				...
				{
					href:'/#tools/activate_students',
					name:'Activate Students',
					key:'activate_students'
				},
				{
			...
			<div>
				...
				<div className="bSchoolMaster">
					<RouterView routes={binding.sub('toolsRouting')} binding={global}>
						...
						/>
						<Route
							path 		= "/tools/activate_students"
							binding 	= { binding.sub('activateStudents') }
							component 	= { ActivateStudentsComponent }
						/>
						<Route
