...
const	{ PlayersList }		= require('module/ui/managers/team_manager/children_booking_all_children_player_chooser/players_list'),
...
const ChildrenBookingAllChildrenPlayerChooser = React.createClass({
	propTypes: {
...
module.exports = ChildrenBookingAllChildrenPlayerChooser;