...
const LoginUserForm = React.createClass({
	...
	render: function() {
		...
		return (
			<Form name={self.tmpFormName} service={window.Server.superAdmin.login} binding={self.getDefaultBinding()} onSuccess={self.props.onSuccess} onError={self.props.onError}>
